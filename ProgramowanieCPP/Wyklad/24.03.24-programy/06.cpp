...
class Osoba 
{
    ...
    public:
        ...
        // Funkcja Drukuj() jest virtualna poniewarz w klacie Ksiegowosc 
        // funkcja DrukujPIT() wywwołuje te Funkcje i ma byc wywoływana z tej klasy która reprezentuje obiekt
